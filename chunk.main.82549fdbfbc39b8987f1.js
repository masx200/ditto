          ...
          ((n && n.Hub) ||
            ...
            (function (e) {
              ...
              var i = [],
                o = function (e) {
                  var t = e.constructor;
                  for (var n in (t || (t = function () {}), e))
                    "constructor" !== n && e.hasOwnProperty(n) && (t[n] = e[n]);
                  return t;
                };
              (t.Object = o({
                ...
                Init: function (e) {
                  ...
                  return 1 === e.length && e[0] === i
                    ? t
                    : (t instanceof e.callee || (t = new e.callee(i)),
                      t.Init.apply(t, e) || t);
                },
                Augment: function (e, t) {
                  ...
                  if (null != e) {
                    for (n in e)
                      e.hasOwnProperty(n) && this.protoFunction(n, e[n]);
                    e.toString !== this.prototype.toString &&
                      e.toString !== {}.toString &&
                      this.protoFunction("toString", e.toString);
                  }
                  if (null != t)
                ...
                protoFunction: function (e, t) {
                  (this.prototype[e] = t),
                    "function" === typeof t && (t.SUPER = this.SUPER.prototype);
                },
                prototype: {
                  Init: function () {},
                  SUPER: function (e) {
                  ...
                  isa: function (e) {
                    return e instanceof Object && this instanceof e;
                  },
                },
                can: function (e) {
                ...
                SimpleSUPER: o({
                  ...
                  define: function (e) {
                    ...
                    if (null != e) {
                      for (var n in e)
                        e.hasOwnProperty(n) && (t[n] = this.wrap(n, e[n]));
                      e.toString !== this.prototype.toString &&
                        e.toString !== {}.toString &&
                        (t.toString = this.wrap("toString", e.toString));
                    }
                    return t;
                  },
                  wrap: function (e, t) {
            ...
            (function (e) {
                ...
                o = function e(t) {
                  ...
                  for (var i in e.prototype)
                    e.prototype.hasOwnProperty(i) &&
                      (n[i] =
                        "undefined" !== typeof t[i] ? t[i] : e.prototype[i]);
                  return (n.toString = e.prototype.toString), n;
                };
              o.prototype = {
                isCallback: !0,
                hook: function () {},
              ...
              var r = function (e) {
                  return "function" === typeof e && e.isCallback;
                },
                s = function (e) {
                ...
                l = function (e, t) {
                  ...
                  if (i(e)) {
                    ...
                    if ("function" === typeof e[0])
                      return o({ hook: e[0], data: e.slice(1) });
                    if ("function" === typeof e[1])
                      return o({ hook: e[1], object: e[0], data: e.slice(2) });
                  } else {
                    if ("string" === typeof e)
                      return a && a(), o({ hook: s, data: [e] });
                ...
                c = function () {
                  ...
                  if (r(t) && !t.called) h(t, e);
                    ...
                    for (var n = 0, i = e.length; n < i; n++)
                      e[n].pending--, e[n].pending <= 0 && e[n].call();
                },
                h = function (e, t) {
                  i(t) || (t = [t]),
                    e.signal
                ...
                p = n.Object.Subclass({
                  ...
                  Add: function (e, t) {
                    null == t && (t = 10), r(e) || (e = l(e)), (e.priority = t);
                    for (
                      var n = this.hooks.length;
                      n > 0 && t < this.hooks[n - 1].priority;
                  ...
                  Remove: function (e) {
                    for (var t = 0, n = this.hooks.length; t < n; t++)
                      if (this.hooks[t] === e)
                  ...
                  Execute: function () {
                    ...
                    for (var t = 0, n = this.hooks.length; t < n; t++) {
                      ...
                      var i = this.hooks[t].apply(window, arguments);
                  ...
                  RemovePending: function () {
                    ...
                    for (var e = this.remove.length - 1; e >= 0; e--)
                ...
                f = t.Object.Subclass({
                  ...
                  Push: function () {
                    for (var e, t = 0, n = arguments.length; t < n; t++)
                      (e = l(arguments[t])) !== arguments[t] ||
                        e.called ||
                        (e = l(["wait", this, e])),
                        this.queue.push(e);
                    return this.running || this.pending || this.Process(), e;
                  },
                  Process: function (e) {
                    for (
                      ;
                      ...
                      var n = t();
                      this.Resume(),
                        e.length && (this.queue = e.concat(this.queue)),
                ...
                m = f.Subclass(
                  {
                    ...
                    Post: function (e, t, n) {
                      if (((t = l(t)), this.posting || this.pending))
                        this.Push(["Post", this, e, t, n]);
                      else {
                        (this.callback = t),
                          t.reset(),
                          ...
                          this.Suspend(),
                          (this.posting = !0);
                        var i = this.listeners.Execute(e);
                    ...
                    Interest: function (e, t, n) {
                      if (((e = l(e)), this.listeners.Add(e, n), !t))
                        for (var i = 0, o = this.posted.length; i < o; i++) {
                          e.reset();
                          var s = e(this.posted[i]);
                          r(s) && i === this.posted.length - 1 && u(s, this);
                        }
                      return e;
                    },
                    ...
                    MessageHook: function (e, t, n) {
                      (t = l(t)),
                        ...
                        this.hooks[e] || (this.hooks[e] = p(!0)),
                        this.hooks[e].Add(t, n);
                      for (var i = 0, o = this.posted.length; i < o; i++)
                        this.posted[i] == e && (t.reset(), t(this.posted[i]));
                      return (t.msg = e), t;
                    },
                    ExecuteHooks: function (e) {
                      var t = i(e) ? e[0] : e;
                      return this.hooks[t] ? this.hooks[t].Execute(e) : null;
                    },
                  ...
                  },
                  {
                    ...
                    find: function (e) {
                      return (
                        m.signals[e] || (m.signals[e] = new m(e)), m.signals[e]
                      );
                    },
                  }
                );
              (t.Callback = t.CallBack = l),
                (t.Callback.Delay = function (e, t) {
                  return ((t = l(t)).timeout = setTimeout(t, e)), t;
                }),
                (t.Callback.After = d),
                (t.Callback.Queue = f),
                ...
                (t.Callback.ExecuteHooks = function (e, t, n) {
                  if (!e) return null;
                  i(e) || (e = [e]), i(t) || (t = null == t ? [] : [t]);
                  for (var o = p(n), r = 0, s = e.length; r < s; r++)
                    o.Add(e[r]);
              ...
              t.Ajax = {
                ...
                fileURL: function (e) {
                  for (
                    ...
                    e =
                      (l[t[1]] || this.config.root) + e.substr(t[1].length + 2);
                  return e;
                },
                fileName: function (t) {
                  var n = this.config.root;
                  t.substr(0, n.length) === n &&
                    (t = "[" + e + "]" + t.substr(n.length));
                  do {
                    var i = !1;
                    for (var o in l)
                      if (
                        l.hasOwnProperty(o) &&
                        l[o] &&
                        t.substr(0, l[o].length) === l[o]
                      ) {
                        (t = "[" + o + "]" + t.substr(l[o].length)), (i = !0);
                        break;
                      }
                  } while (i);
                  return t;
                ...
                fileRev: function (e) {
                  var n = t.cdnFileVersions[e] || t.cdnVersion || "";
                  return n && (n = "?V=" + n), n;
                },
                urlRev: function (e) {
                ...
                Require: function (e, n) {
                  var i;
                  if (((n = t.Callback(n)), e instanceof Object))
                    for (var o in e)
                      e.hasOwnProperty(o) &&
                        ((i = o.toUpperCase()), (e = e[o]));
                  else i = e.split(/\./).pop().toUpperCase();
                  if (this.params.noContrib && "[Contrib]" === e.substr(0, 9))
                    n(this.STATUS.ERROR);
                  else if (((e = this.fileURL(e)), this.loaded[e]))
                    n(this.loaded[e]);
                  else {
                    var r = {};
                    (r[i] = e), this.Load(r, n);
                ...
                Load: function (e, n) {
                  ...
                  if (((e = this.fileURL(e)), this.loading[e]))
                    this.addHook(e, n);
                  else {
                    if (((this.head = r(this.head)), !this.loader[i]))
                ...
                LoadHook: function (e, n, i) {
                  if (((n = t.Callback(n)), e instanceof Object))
                    for (var o in e) e.hasOwnProperty(o) && (e = e[o]);
                  return (
                    (e = this.fileURL(e)),
                    this.loaded[e] ? n(this.loaded[e]) : this.addHook(e, n, i),
                    n
                  );
                },
                addHook: function (e, t, i) {
                  this.loadHooks[e] || (this.loadHooks[e] = n.Callback.Hooks()),
                ...
                Preloading: function () {
                  for (var e = 0, t = arguments.length; e < t; e++) {
                    ...
                    this.loading[n] || (this.loading[n] = { preloaded: !0 });
                  }
                },
                loader: {
                  JS: function (e, n) {
                    var i = this.fileName(e),
                      ...
                      r = t.Callback(["loadTimeout", this, e]);
                    (this.loading[e] = {
                      callback: n,
                      timeout: setTimeout(r, this.timeout),
                      status: this.STATUS.OK,
                      script: o,
                    }),
                      (this.loading[e].message = t.Message.File(i)),
                      (o.onerror = r),
                  ...
                  CSS: function (e, n) {
                    ...
                    (o.rel = "stylesheet"),
                      ...
                      this.head.appendChild(o),
                      this.timer.create.call(this, [this.timer.file, e], o);
                  },
                },
                timer: {
                  create: function (e, n) {
                    return (
                      ...
                      "STYLE" === n.nodeName &&
                      n.styleSheet &&
                      "undefined" !== typeof n.styleSheet.cssText
                        ? e(this.STATUS.OK)
                        : window.chrome && "LINK" === n.nodeName
                        ? e(this.STATUS.OK)
                        : i
                        ? this.timer.start(
                            this,
                            [this.timer.checkSafari2, o++, e],
                            this.styleDelay
                          )
                        : this.timer.start(
                            this,
                            [this.timer.checkLength, n, e],
                            this.styleDelay
                          ),
                      e
                    );
                  ...
                  start: function (e, n, i, o) {
                    ((n = t.Callback(n)).execute = this.execute),
                      (n.time = this.time),
                      (n.STATUS = e.STATUS),
                  ...
                  time: function (e) {
                    return (
                      ...
                      this.total >= this.timeout ? (e(this.STATUS.ERROR), 1) : 0
                    );
                  },
                  file: function (e, n) {
                    n < 0 ? t.Ajax.loadTimeout(e) : t.Ajax.loadComplete(e);
                  },
                  execute: function () {
                    this.hook.call(
                      this.object,
                  ...
                  checkSafari2: function (e, t, n) {
                    e.time(n) ||
                      ...
                      document.styleSheets[t].cssRules.length
                        ? n(e.STATUS.OK)
                  ...
                  checkLength: function (e, n, i) {
                    if (!e.time(i)) {
                      ...
                      try {
                        (r.cssRules || r.rules || []).length > 0 && (o = 1);
                      } catch (s) {
                        s.message.match(/protected variable|restricted URI/)
                          ? (o = 1)
                          : s.message.match(/Security error/) && (o = 1);
                      }
                      o
                        ? setTimeout(t.Callback([i, e.STATUS.OK]), 0)
                        : setTimeout(e, e.delay);
                    }
                  },
                },
                loadComplete: function (e) {
                  ...
                  return (
                    ...
                    this.loadHooks[e]
                      ? this.loadHooks[e].Execute(n.status)
                      : null
                  );
                },
                loadTimeout: function (e) {
                  this.loading[e].timeout &&
                    ...
                    (this.loading[e].status = this.STATUS.ERROR),
                    this.loadError(e),
                    this.loadComplete(e);
                },
                loadError: function (e) {
                  t.Message.Set(
                    ["LoadFailed", "File failed to load: %1", e],
                    null,
                    2e3
                  ),
                    t.Hub.signal.Post(["file load error", e]);
                },
                Styles: function (e, n) {
                  ...
                  if ("" === i) (n = t.Callback(n))();
                    ...
                    (o.type = "text/css"),
                      ...
                      this.head.appendChild(o),
                      o.styleSheet &&
                      "undefined" !== typeof o.styleSheet.cssText
                        ? (o.styleSheet.cssText = i)
                        : o.appendChild(document.createTextNode(i)),
                      (n = this.timer.create.call(this, n, o));
                  }
                  return n;
                },
                    ...
                    if (e.hasOwnProperty(n))
                      if ("string" === typeof e[n])
                        ...
                        for (var r = 0; r < e[n].length; r++)
                          ((i = {})[n] = e[n][r]), (o += this.StyleString(i));
                      else if ("@media" === n.substr(0, 6))
                        o += n + " {" + this.StyleString(e[n]) + "}\n";
                      else if (null != e[n]) {
                        for (var s in ((i = []), e[n]))
              ...
              Element: function (e, t, i) {
                ...
                if (t) {
                  if (t.hasOwnProperty("style")) {
                    ...
                    for (o in ((t.style = {}), s))
                      s.hasOwnProperty(o) &&
                        (t.style[o.replace(/-([a-z])/g, this.ucMatch)] = s[o]);
                  }
                  for (o in (n.Hub.Insert(r, t), t))
                    ("role" !== o && "aria-" !== o.substr(0, 5)) ||
                ...
                if (i) {
                  ...
                  for (var a = 0, l = i.length; a < l; a++)
                    n.Object.isArray(i[a])
                      ? r.appendChild(this.Element(i[a][0], i[a][1], i[a][2]))
                      : "script" === e
              ...
              Cookie: {
                ...
                Set: function (e, t) {
                  ...
                  if (t)
                    for (var i in t)
                      t.hasOwnProperty(i) &&
                        n.push(i + ":" + t[i].toString().replace(/&/g, "&&"));
                  var o = this.prefix + "." + e + "=" + escape(n.join("&;"));
                  if (this.expires) {
                    var r = new Date();
                ...
                Get: function (e, t) {
                  ...
                  if (n && "" !== n[1])
                    for (
                      var o = unescape(n[1]).split("&;"), r = 0, s = o.length;
                      r < s;
                      r++
                    ) {
                      var a = (n = o[r].match(/([^:]+):(.*)/))[2].replace(
                        /&&/g,
                        "&"
                      );
                      "true" === a
            ...
            (n.Localization = {
              ...
              processString: function (e, t, i) {
                ...
                for (o = 0, r = t.length; o < r; o++)
                  i && s(t[o]) && (t[o] = this.processSnippet(i, t[o]));
                var a = this.SPLIT(e, this.pattern);
                for (o = 1, r = a.length; o < r; o += 2) {
                  var l = a[o].charAt(0);
                  if (l >= "0" && l <= "9")
                    (a[o] = t[a[o] - 1]),
                      "number" === typeof a[o] && (a[o] = this.number(a[o]));
                  else if ("{" === l)
                    if ((l = a[o].substr(1)) >= "0" && l <= "9")
                      (a[o] = t[a[o].substr(1, a[o].length - 2) - 1]),
                        "number" === typeof a[o] && (a[o] = this.number(a[o]));
                    else {
                      var u = a[o].match(/^\{([a-z]+):%(\d+)\|(.*)\}$/);
                      if (u)
                        if ("plural" === u[1]) {
                          var c = t[u[2] - 1];
                          if ("undefined" === typeof c) a[o] = "???";
                          else {
                            c = this.plural(c) - 1;
                            var h = u[3]
                              .replace(/(^|[^%])(%%)*%\|/g, "$1$2%\uefef")
                ...
                for (var i = [], o = 0, r = t.length; o < r; o++)
                  if (n.Object.isArray(t[o])) {
                    ...
                    if ("string" === typeof s[1]) {
                      ...
                      i = i.concat(this.processMarkdown(l, s.slice(2), e));
                    } else
                      n.Object.isArray(s[1])
                        ? (i = i.concat(this.processSnippet.apply(this, s)))
                        : s.length >= 3
                        ? i.push([s[0], s[1], this.processSnippet(e, s[2])])
                        : i.push(t[o]);
                  } else i.push(t[o]);
                return i;
              },
              ...
              processMarkdown: function (e, t, i) {
                for (
                  ...
                  s[l + 1]
                    ? ((o = this.processString(s[l + 2], t, i)),
                      n.Object.isArray(o) || (o = [o]),
                      (o = [["b", "i", "i"][s[l + 1].length - 1], {}, o]),
                      3 === s[l + 1].length && (o = ["b", {}, o]))
                    : s[l + 3]
                    ? ((o = this.processString(
                        s[l + 4].replace(/^\s/, "").replace(/\s$/, ""),
                        t,
                        i
                      )),
                      n.Object.isArray(o) || (o = [o]),
                      (o = ["code", {}, o]))
                    : s[l + 5]
                    ? ((o = this.processString(s[l + 5], t, i)),
                      n.Object.isArray(o) || (o = [o]),
                      (o = [
                        "a",
                        {
                          href: this.processString(s[l + 6], t),
                          target: "_blank",
                        },
                        o,
                      ]))
                    : ((a += s[l]), (o = null)),
                    o &&
                      ((r = this.concatString(r, a, t, i)).push(o), (a = "")),
                    "" !== s[l + 7] && (a += s[l + 7]);
              ...
              loadDomain: function (e, t) {
                ...
                if (o) {
                  if (!o.isLoaded && (i = this.loadFile(this.locale, o)))
                    return n.Callback.Queue(i, ["loadDomain", this, e]).Push(
                      t || {}
                    );
                  if (o.domains && e in o.domains) {
                    var r = o.domains[e];
                    if (!r.isLoaded && (i = this.loadFile(e, r)))
              ...
              Try: function (e) {
                ...
                try {
                  ...
                  n.Callback.After(["Try", this, e], t.restart);
                }
              },
              resetLocale: function (e) {
                if (e) {
                  for (e = e.toLowerCase(); !this.strings[e]; ) {
                    var t = e.lastIndexOf("-");
                    if (-1 === t) return;
                    e = e.substring(0, t);
                  }
              ...
              setLocale: function (e) {
                this.resetLocale(e), n.Menu && this.loadDomain("MathMenu");
              },
              addTranslation: function (e, t, i) {
                ...
                o || ((o = this.strings[e] = {}), (r = !0)),
                  o.domains || (o.domains = {}),
                  t &&
                    (o.domains[t] || (o.domains[t] = {}), (o = o.domains[t])),
                  n.Hub.Insert(o, i),
                  r && n.Menu.menu && n.Menu.CreateLocaleMenu();
              },
              setCSS: function (e) {
                var t = this.strings[this.locale];
                return (
                  t &&
                    (t.fontFamily && (e.style.fontFamily = t.fontFamily),
                    t.fontDirection &&
                      ((e.style.direction = t.fontDirection),
                      "rtl" === t.fontDirection &&
              ...
              plural: function (e) {
                var t = this.strings[this.locale];
                return t && t.plural ? t.plural(e) : 1 == e ? 1 : 2;
              },
              number: function (e) {
                var t = this.strings[this.locale];
            ...
            (n.Message = {
              ...
              browsers: {
                MSIE: function (e) {
                  (n.Message.msieFixedPositionBug =
                    ...
                    n.Message.msieFixedPositionBug &&
                      (n.Hub.config.styles["#MathJax_Message"].position =
                        "absolute"),
                    (n.Message.quirks = "BackCompat" === document.compatMode);
                },
                Chrome: function (e) {
                  (n.Hub.config.styles["#MathJax_Message"].bottom = "1.5em"),
                    (n.Hub.config.styles["#MathJax_Message"].left = "1em");
                },
              },
              Init: function (e) {
                if ((e && (this.ready = !0), !document.body || !this.ready))
                  return !1;
                if (
                  (this.div &&
                  ...
                  this.msieFixedPositionBug &&
                    window.attachEvent &&
                    ((t = this.frame =
                      this.addDiv(document.body)).removeAttribute("id"),
                    (t.style.position = "absolute"),
                    (t.style.border = t.style.margin = t.style.padding = "0px"),
                    (t.style.zIndex = "101"),
                    (t.style.height = "0px"),
                    ((t = this.addDiv(t)).id = "MathJax_MSIE_Frame"),
              ...
              MoveFrame: function () {
                ...
                (t.style.left = e.scrollLeft + "px"),
                  ...
                  ((t = t.firstChild).style.height = e.clientHeight + "px");
              },
              localize: function (e) {
              ...
              Set: function (e, t, i) {
                null == t && ((t = this.log.length), (this.log[t] = {}));
                var o = "";
                if (n.Object.isArray(e)) {
                  (o = e[0]), n.Object.isArray(o) && (o = o[1]);
                  try {
                    e = n.Localization._.apply(n.Localization, e);
                  } catch (r) {
                    ...
                    if (!r.restart.called)
                      return (
                        ...
                        n.Callback.After(["Set", this, e, t, i], r.restart),
                        t
                      );
                  }
                }
                return (
                  ...
                  (this.log[t].text = e),
                  (this.log[t].filteredText = e = this.filterText(e, t, o)),
                  "undefined" === typeof this.log[t].next &&
                    ((this.log[t].next = this.current),
                    null != this.current && (this.log[this.current].prev = t),
                    (this.current = t)),
                  this.current === t &&
                    ...
                    (this.Init()
                      ...
                      : ((window.status = e), (this.status = !0))),
                  this.log[t].restarted &&
                    (this.log[t].cleared && (i = 0),
                    0 === --this.log[t].restarted &&
                      delete this.log[t].cleared),
                  i
                    ? setTimeout(n.Callback(["Clear", this, t]), i)
                    : 0 == i && this.Clear(t, 0),
                  t
                );
              },
              Clear: function (e, t) {
                null != this.log[e].prev &&
                  (this.log[this.log[e].prev].next = this.log[e].next),
                  null != this.log[e].next &&
                    (this.log[this.log[e].next].prev = this.log[e].prev),
                  this.current === e &&
                  ...
                  this.log[e].restarted && (this.log[e].cleared = !0);
              },
              Remove: function () {
                (this.text.nodeValue = ""), (this.div.style.display = "none");
              },
              File: function (e) {
                return this.Set(["LoadFile", "Loading %1", e], null, null);
              },
              Log: function () {
                for (var e = [], t = 1, n = this.log.length; t < n; t++)
                  e[t] = this.log[t].text;
                return e.join("\n");
              },
            }),
            (n.Hub = {
              ...
              Register: {
                ...
                LoadHook: function () {
                  return n.Ajax.LoadHook.apply(n.Ajax, arguments);
                },
              },
              UnRegister: {
              ...
              getAllJax: function (e) {
                for (
                  var t = [], n = this.elementScripts(e), i = 0, o = n.length;
                  i < o;
                  i++
                )
                  n[i].MathJax &&
              ...
              getJaxByType: function (e, t) {
                for (
                  var n = [], i = this.elementScripts(t), o = 0, r = i.length;
                  o < r;
                  o++
                )
                  i[o].MathJax &&
                    i[o].MathJax.elementJax &&
                    i[o].MathJax.elementJax.mimeType === e &&
              ...
              getJaxFor: function (e) {
                ...
                if (this.isMathJaxNode(e)) {
                  for (e.isMathJax || (e = e.firstChild); e && !e.jaxID; )
                    e = e.parentNode;
                  if (e) return n.OutputJax[e.jaxID].getJaxFromMath(e);
                }
                return null;
              },
              isJax: function (e) {
                ...
                if (e && "script" === (e.tagName || "").toLowerCase()) {
                  if (e.MathJax)
                    return e.MathJax.state === n.ElementJax.STATE.PROCESSED
                      ? 1
                      : -1;
                  if (e.type && this.inputJax[e.type.replace(/ *;(.|\s)*/, "")])
                    return -1;
                }
                return 0;
              },
              isMathJaxNode: function (e) {
                return (
                  !!e &&
                  (e.isMathJax || "MathJax_MathML" === (e.className || ""))
                );
              },
              setRenderer: function (e, t) {
                if (e) {
                  ...
                  if (i) {
                    ...
                    return o[t] && o[t].length && e !== o[t][0].id
                      ? (o[t].unshift(i),
                        this.signal.Post(["Renderer Selected", e]))
                      : null;
                  }
                  ...
                  var r = "[MathJax]/jax/output/" + e + "/config.js";
                  return n.Ajax.Require(r, ["setRenderer", this, e, t]);
                }
              },
              Queue: function () {
              ...
              PreProcess: function (e, t) {
                var i = this.elementCallback(e, t),
                  o = n.Callback.Queue();
                if (i.count) {
                  var r = 1 === i.count ? [i.elements] : i.elements;
                  o.Push([
                    "Post",
                    this.signal,
                  ...
                  for (var s = 0, a = r.length; s < a; s++)
                    r[s] && o.Push(["Execute", this.preProcessors, r[s]]);
                  o.Push(["Post", this.signal, ["End PreProcess", i.elements]]);
                }
                return o.Push(i.callback);
              },
              ...
              takeAction: function (e, t, i) {
                var o = this.elementCallback(t, i),
                  r = o.elements,
                  s = n.Callback.Queue(["Clear", this.signal]),
                  a = {
                    scripts: [],
                ...
                if (o.count) {
                  var l = ["Delay", n.Callback, this.processSectionDelay];
                  l[2] || (l = {}),
                    s.Push(
                      ["clearCounts", n.Message],
                      ["Post", this.signal, ["Begin " + e, r]],
                      ["Post", this.signal, ["Begin Math", r, e]],
                      ["prepareScripts", this, e, r, a],
                      ["Post", this.signal, ["Begin Math Input", r, e]],
                      ["processInput", this, a],
                      ["Post", this.signal, ["End Math Input", r, e]],
                      l,
                      ["prepareOutput", this, a, "preProcess"],
                      l,
                      ["Post", this.signal, ["Begin Math Output", r, e]],
                      ["processOutput", this, a],
                      ["Post", this.signal, ["End Math Output", r, e]],
                      l,
                      ["prepareOutput", this, a, "postProcess"],
                      l,
                      ["Post", this.signal, ["End Math", r, e]],
                      ["Post", this.signal, ["End " + e, r]],
                      ["clearCounts", n.Message]
                    );
                }
              ...
              scriptAction: {
                ...
                Update: function (e) {
                  ...
                  t && t.needsUpdate()
                    ? (t.Remove(!0), (e.MathJax.state = t.STATE.UPDATE))
                    : (e.MathJax.state = t.STATE.PROCESSED);
                },
                Reprocess: function (e) {
                  var t = e.MathJax.elementJax;
                  t && (t.Remove(!0), (e.MathJax.state = t.STATE.UPDATE));
                },
                Rerender: function (e) {
                  var t = e.MathJax.elementJax;
                  t && (t.Remove(!0), (e.MathJax.state = t.STATE.OUTPUT));
                },
              },
              prepareScripts: function (e, t, i) {
                if (!arguments.callee.disabled)
                  for (
                    ...
                    var l = o[s];
                    l.type &&
                      this.inputJax[l.type.replace(/ *;(.|\n)*/, "")] &&
                      (l.MathJax &&
                        (l.MathJax.elementJax &&
                          l.MathJax.elementJax.hover &&
                          n.Extension.MathEvents.Hover.ClearHover(
                            l.MathJax.elementJax
                          ),
                        l.MathJax.state !== r.PENDING &&
                          this.scriptAction[e](l)),
                      l.MathJax || (l.MathJax = { state: r.PENDING }),
                      l.MathJax.error && delete l.MathJax.error,
                      l.MathJax.state !== r.PROCESSED && i.scripts.push(l));
                  }
              },
                ...
                if (!e.MathJax.checked) {
                  ...
                  if (n && "#text" === n.nodeName) {
                    var i,
                      o,
                      r = e.nextSibling;
                    r && "#text" !== r.nodeName && (r = null),
                      t.preJax &&
                        ("string" === typeof t.preJax &&
                          (t.preJax = new RegExp(t.preJax + "$")),
                        (i = n.nodeValue.match(t.preJax))),
                      t.postJax &&
                        r &&
                        ("string" === typeof t.postJax &&
                          (t.postJax = new RegExp("^" + t.postJax)),
                        (o = r.nodeValue.match(t.postJax))),
                      !i ||
                        (t.postJax && !o) ||
                      ...
                      n && !n.nodeValue.match(/\S/) && (n = n.previousSibling);
                  }
                  t.preRemoveClass &&
                    n &&
                ...
                try {
                  for (; e.i < s; )
                    if ((i = e.scripts[e.i]))
                      if (
                        ((o = i.previousSibling) &&
                          "MathJax_Error" === o.className &&
                          o.parentNode.removeChild(o),
                        i.parentNode &&
                          i.MathJax &&
                          i.MathJax.state !== r.PROCESSED)
                      ) {
                        if (
                          i.MathJax.elementJax &&
                          i.MathJax.state !== r.UPDATE
                        )
                          i.MathJax.state === r.OUTPUT &&
                            this.saveScript(i.MathJax.elementJax, e, i, r);
                        else {
                          this.checkScriptSiblings(i);
                          var a = i.type.replace(/ *;(.|\s)*/, ""),
                            l = this.inputJax[a];
                          if ("function" === typeof (t = l.Process(i, e))) {
                            if (t.called) continue;
                            this.RestartAfter(t);
                          }
                          (t = t.Attach(i, l.id)),
                            this.saveScript(t, e, i, r),
                            this.postInputHooks.Execute(t, l.id, i);
                        }
                        e.i++;
                        var u = new Date().getTime();
                        u - e.start > this.processUpdateTime &&
                          e.i < e.scripts.length &&
                          ((e.start = u),
                          this.RestartAfter(n.Callback.Delay(1)));
                      } else e.i++;
                    else e.i++;
                } catch (c) {
              ...
              saveScript: function (e, t, n, i) {
                if (!this.outputJax[e.mimeType])
                  throw (
                    ...
                    Error("No output jax registered for " + e.mimeType))
                  );
                (e.outputJax = this.outputJax[e.mimeType][0].id),
                  t.jax[e.outputJax] ||
                    (0 === t.jaxIDs.length
                      ? (t.jax[e.outputJax] = t.scripts)
                      : (1 === t.jaxIDs.length &&
                          (t.jax[t.jaxIDs[0]] = t.scripts.slice(0, t.i)),
                        (t.jax[e.outputJax] = [])),
                    t.jaxIDs.push(e.outputJax)),
                  t.jaxIDs.length > 1 && t.jax[e.outputJax].push(n),
                ...
                try {
                  for (; e.i < o; )
                    if (
                      ...
                      if (r) {
                        !1 !== n.OutputJax[r.outputJax].Process(t, e) &&
                          ((t.MathJax.state = i.PROCESSED),
                          t.MathJax.preview &&
                            ((t.MathJax.preview.innerHTML = ""),
                            (t.MathJax.preview.style.display = "none")),
                          this.signal.Post(["New Math", r.inputID])),
                          e.i++;
                        var s = new Date().getTime();
                        s - e.start > this.processUpdateTime &&
                          e.i < e.scripts.length &&
                          ((e.start = s),
                          this.RestartAfter(
                            n.Callback.Delay(this.processUpdateDelay)
                          ));
                      } else e.i++;
                    } else e.i++;
                } catch (a) {
              ...
              processMessage: function (e, t) {
                var i = Math.floor((e.i / e.scripts.length) * 100),
                  o =
                    "Output" === t
              ...
              processError: function (e, t, i) {
                if (!e.restart) {
                  if (!this.config.errorSettings.message) throw e;
                  this.formatError(t.scripts[t.i], e), t.i++;
                }
                return (
                  this.processMessage(t, i),
                  n.Callback.After(["process" + i, this, t], e.restart)
                );
              },
              formatError: function (e, t) {
                var i = function (e, t, i, o) {
                  ...
                  o = i("ErrorMessage", "Error: %1", t.message) + "\n";
                (t.sourceURL || t.fileName) &&
                  (o +=
                    "\n" +
                    i("ErrorFile", "file: %1", t.sourceURL || t.fileName)),
                  (t.line || t.lineNumber) &&
                    (o +=
                      "\n" +
                      i("ErrorLine", "line: %1", t.line || t.lineNumber)),
                  (o +=
                    "\n\n" +
                    i(
                      "ErrorTips",
                  ...
                  (e.MathJax.error = n.OutputJax.Error.Jax(o, e)),
                  e.MathJax.elementJax &&
                    (e.MathJax.error.inputID = e.MathJax.elementJax.inputID);
                var r = this.config.errorSettings,
                  ...
                  a = n.HTML.Element(
                    "span",
                    {
                      ...
                      jaxID: "Error",
                      isMathJax: !0,
                      id: e.MathJax.error.inputID + "-Frame",
                    },
                    [["span", null, s]]
                  );
                n.Ajax.Require(
                  ...
                  function () {
                    ...
                    (a.oncontextmenu = t.Menu),
                      ...
                      (a.tabIndex = i.getTabOrder(i.getJaxFor(e)));
                  }
                );
                ...
                l && l.parentNode.removeChild(l),
                  ...
                  (this.lastError = t),
                  this.signal.Post(["Math Processing Error", e, t]);
              },
              RestartAfter: function (e) {
                throw this.Insert(Error("restart"), { restart: n.Callback(e) });
              },
              elementCallback: function (e, t) {
                if (
                  null == t &&
                  (n.Object.isArray(e) || "function" === typeof e)
                )
                  try {
                ...
                for (var i = 0, o = (e = [].concat(e)).length; i < o; i++)
                  "string" === typeof e[i] &&
              ...
              elementScripts: function (e) {
                var t = [];
                if (n.Object.isArray(e) || this.isHTMLCollection(e)) {
                  for (var i = 0, o = e.length; i < o; i++) {
                    for (var r = 0, s = 0; s < i && !r; s++)
                      r = e[s].contains(e[i]);
                    r || t.push.apply(t, this.elementScripts(e[i]));
                  }
                  return t;
                }
                return (
                  ...
                  null != e.tagName && "script" === e.tagName.toLowerCase()
                    ? [e]
                    : ((t = e.getElementsByTagName("script")),
                      this.msieHTMLCollectionBug &&
                        (t = this.HTMLCollection2Array(t)),
                      t)
                );
              },
              ...
              HTMLCollection2Array: function (e) {
                if (!this.msieHTMLCollectionBug) return [].slice.call(e);
            ...
            (n.Hub.Startup = {
              ...
              Config: function () {
                if (
                  ...
                  n.AuthorConfig &&
                    n.AuthorConfig.root &&
                    (n.Ajax.config.root = n.AuthorConfig.root),
                  this.params.locale &&
                    (n.Localization.resetLocale(this.params.locale),
                    (n.Hub.config.menuSettings.locale = this.params.locale)),
                  this.params.config)
                )
                  for (
                    var e = this.params.config.split(/,/), t = 0, i = e.length;
                    t < i;
                    t++
                  )
                    e[t].match(/\.js$/) || (e[t] += ".js"),
                ...
                this.queue.Push(["Config", n.Hub, n.AuthorConfig]),
                  this.script.match(/\S/) &&
              ...
              Cookie: function () {
                return this.queue.Push(
                  ...
                  ["Get", n.HTML.Cookie, "menu", n.Hub.config.menuSettings],
                  [
                    function (e) {
                      var t = e.menuSettings;
                      t.locale && n.Localization.resetLocale(t.locale);
                      ...
                      null != t.CHTMLpreview &&
                        (null == t.FastPreview &&
                          (t.FastPreview = t.CHTMLpreview),
                        delete t.CHTMLpreview),
                        t.FastPreview &&
                          !n.Extension["fast-preview"] &&
                          n.Hub.config.extensions.push("fast-preview.js"),
                        e.menuSettings.assistiveMML &&
                          !n.Extension.AssistiveMML &&
                          n.Hub.config.extensions.push("AssistiveMML.js");
                    },
                    n.Hub.config,
                  ],
              ...
              Styles: function () {
                return this.queue.Push(
                  ...
                  ["loadArray", this, n.Hub.config.styleSheets, "config"],
              ...
              Jax: function () {
                ...
                return n.Callback.Queue().Push(
                  ...
                  ["loadArray", this, e.jax, "jax", "config.js"],
              ...
              Extensions: function () {
                return n.Callback.Queue().Push(
                  ...
                  ["loadArray", this, n.Hub.config.extensions, "extensions"],
              ...
              Hash: function () {
                if (
                  ...
                  var e = decodeURIComponent(document.location.hash.substr(1)),
                  ...
                  if (t) {
                    for (; !t.scrollIntoView; ) t = t.parentNode;
                    (t = this.HashCheck(t)) &&
                      t.scrollIntoView &&
                      setTimeout(function () {
                        t.scrollIntoView(!0);
              ...
              HashCheck: function (e) {
                ...
                return (
                  t &&
                    ...
                    (e = n.OutputJax[t.outputJax].hashCheck(e)),
                  e
                );
              },
              MenuZoom: function () {
                n.Hub.config.showMathMenu &&
                  (n.Extension.MathMenu
                    ? setTimeout(
                        n.Callback(["loadDomain", n.Localization, "MathMenu"]),
                        1e3
                      )
                    : setTimeout(function () {
                        n.Callback.Queue(
                          ...
                          ["loadDomain", n.Localization, "MathMenu"]
                        );
                      }, 1e3),
              ...
              onLoad: function () {
                ...
                if (document.body && document.readyState)
                  ...
                  } else if ("loading" !== document.readyState) return [e];
                return (
              ...
              loadArray: function (e, t, i, o) {
                if (e && (n.Object.isArray(e) || (e = [e]), e.length)) {
                  for (
                    var r, s = n.Callback.Queue(), a = {}, l = 0, u = e.length;
                    l < u;
                    l++
                  )
                    (r = this.URL(t, e[l])),
                ...
                a = n.Object.Subclass(
                  {
                    ...
                    Augment: function (e, t) {
                      ...
                      if (null != e) {
                        for (var r in e)
                          e.hasOwnProperty(r) &&
                            ("function" === typeof e[r]
                              ? n.protoFunction(r, e[r])
                              : (i[r] = e[r]));
                        e.toString !== n.prototype.toString &&
                          e.toString !== {}.toString &&
                          n.protoFunction("toString", e.toString);
                      }
                      return o.Insert(n.prototype, i), n.Augment(null, t), this;
                    },
                    ...
                    Register: function (e) {},
                    Config: function () {
                      (this.config = o.CombineConfig(this.id, this.config)),
                        this.config.Augment &&
                    ...
                    loadComplete: function (e) {
                      if ("config.js" === e)
                        return r.loadComplete(this.directory + "/" + e);
                      var t = s.Queue();
                      return (
                        t.Push(
                          o.Register.StartupHook("End Config", {}),
                          ["Post", o.Startup.signal, this.id + " Jax Config"],
                          ["Config", this],
                          ["Post", o.Startup.signal, this.id + " Jax Require"],
                          [
                            function (e) {
                          ...
                          ["Post", o.Startup.signal, this.id + " Jax Startup"],
                          ["Startup", this],
                          ["Post", o.Startup.signal, this.id + " Jax Ready"]
                        ),
                        this.copyTranslate &&
                          t.Push([
                            function (e) {
                              (e.preProcess = e.preTranslate),
                                (e.Process = e.Translate),
                                (e.postProcess = e.postTranslate);
                            },
                            this.constructor.prototype,
                          ]),
                        t.Push(["loadComplete", r, this.directory + "/" + e])
                      );
                    },
                  },
                  {
                  ...
                  Process: function (e, n) {
                    ...
                    return (
                      ...
                      (l = o.outputJax["jax/" + l[0]]) &&
                        a.Push(r.Require(l[0].directory + "/" + this.JAXFILE)),
                      a.Push({})
                    );
                  },
                  needsUpdate: function (e) {
                    var n = e.SourceElement();
                    return e.originalText !== t.HTML.getScript(n);
                  },
                  Register: function (e) {
                    o.inputJax || (o.inputJax = {}), (o.inputJax[e] = this);
                  },
                },
                {
                  id: "InputJax",
                ...
                (t.OutputJax = a.Subclass(
                  {
                    ...
                    preProcess: function (e) {
                      var t,
                        n = this.directory + "/" + this.JAXFILE;
                      return (
                        (this.constructor.prototype.preProcess = function (e) {
                          if (!t.called) return t;
                          throw Error(n + " failed to load properly");
                        }),
                        (t = r.Require(n))
                      );
                    },
                    ...
                    Register: function (e) {
                      ...
                      n[e] || (n[e] = []),
                        n[e].length &&
                        (this.id === o.config.menuSettings.renderer ||
                          (n.order[this.id] || 0) < (n.order[n[e][0].id] || 0))
                          ? n[e].unshift(this)
                          : n[e].push(this),
                        this.require
                          ? t.Object.isArray(this.require) ||
                  ...
                  },
                  {
                    ...
                    extensionDir: a.extensionDir,
                    fontDir: i + (t.isPacked ? "" : "/..") + "/fonts",
                    imageDir: i + (t.isPacked ? "" : "/..") + "/images",
                  }
                )),
                (t.ElementJax = a.Subclass(
                  {
                    Init: function (e, t) {
                      return this.constructor.Subclass(e, t);
                    },
                    inputJax: null,
                    outputJax: null,
                    inputID: null,
                    ...
                    Reprocess: function (e) {
                      ...
                      return (
                        (t.MathJax.state = this.STATE.UPDATE), o.Reprocess(t, e)
                      );
                    },
                    Update: function (e) {
                    ...
                    Rerender: function (e) {
                      var t = this.SourceElement();
                      return (
                        (t.MathJax.state = this.STATE.OUTPUT), o.Process(t, e)
                      );
                    },
                    Remove: function (e) {
                      this.hover && this.hover.clear(this),
                        t.OutputJax[this.outputJax].Remove(this),
                        e ||
                          (o.signal.Post(["Remove Math", this.inputID]),
                          this.Detach());
                    },
                    needsUpdate: function () {
                      return t.InputJax[this.inputJax].needsUpdate(this);
                    },
                    ...
                    Attach: function (e, n) {
                      ...
                      return (
                        e.MathJax.state === this.STATE.UPDATE
                          ? i.Clone(this)
                          : ((i = e.MathJax.elementJax = this),
                            e.id
                              ? (this.inputID = e.id)
                              : ((e.id = this.inputID = t.ElementJax.GetID()),
                                (this.newID = 1))),
                        (i.originalText = t.HTML.getScript(e)),
                        (i.inputJax = n),
                  ...
                  },
                  {
                    ...
                    Subclass: function () {
                      var e = a.Subclass.apply(this, arguments);
                      return (e.loadComplete = this.prototype.loadComplete), e;
                    },
                  }
                )),
                (t.ElementJax.prototype.STATE = t.ElementJax.STATE),
                (t.OutputJax.Error = {
                  id: "Error",
                  version: "2.7.5",
                  config: {},
                  ...
                  getJaxFromMath: function (e) {
                    return (e.nextSibling.MathJax || {}).error;
                  },
                  Jax: function (e, t) {
                    var i = n.Hub.inputJax[t.type.replace(/ *;(.|\s)*/, "")];
                    return (
                      this.errors++,
                      {
                        ...
                        originalText: n.HTML.getScript(t),
                        errorText: e,
                      }
                    );
                  },
            ...
            (function (e) {
              ...
              0 === a.length &&
                s.namespaceURI &&
                (a = document.getElementsByTagNameNS(s.namespaceURI, "script"));
              for (
                var l = new RegExp("(^|/)" + e + "\\.js(\\?.*)?$"),
                  u = a.length - 1;
                u >= 0;
                u--
              )
                if ((a[u].src || "").match(l)) {
                  if (((o.script = a[u].innerHTML), RegExp.$2))
                    for (
                      var c = RegExp.$2.substr(1).split(/\&/),
                        h = 0,
                        d = c.length;
                      h < d;
                      h++
                      ...
                      var p = c[h].match(/(.*)=(.*)/);
                      p
                        ? (o.params[unescape(p[1])] = unescape(p[2]))
                        : (o.params[c[h]] = !0);
                    }
              ...
              var f = navigator.userAgent,
                m = {
                  ...
                  isFirefox: !!f.match(/Gecko\//) && !f.match(/like Gecko/),
                  isSafari:
                  ...
                  isKonqueror:
                    "konqueror" in window && "KDE" == navigator.vendor,
                  versionAtLeast: function (e) {
                    for (
                      var t = this.version.split("."),
                        n = 0,
                        i = (e = new String(e).split(".")).length;
                      n < i;
                      n++
                    )
                      if (t[n] != e[n])
                        return parseInt(t[n] || "0") >= parseInt(e[n]);
                    return !0;
                  },
                  Select: function (e) {
                    var t = e[i.Browser];
              ...
              m))
                if (m.hasOwnProperty(x) && m[x] && "is" === x.substr(0, 2)) {
                  ...
                  (i.Browser.name = "" != v[1] ? x : v[3] || v[5]),
                    (i.Browser.version = v[2] || v[4] || v[6]);
                  break;
                }
              try {
                i.Browser.Select({
                  Safari: function (e) {
                    var t = parseInt(String(e.version).split(".")[0]);
                  ...
                  Firefox: function (e) {
                    if (
                      ("0.0" === e.version || null == f.match(/Firefox/)) &&
                      "Gecko" === navigator.product
                    ) {
                      var t = f.match(/[\/ ]rv:(\d+\.\d.*?)[\) ]/);
                      if (t) e.version = t[1];
                      else {
                        var n = (
                          navigator.buildID ||
                  ...
                  Edge: function (e) {
                    e.isMobile = !!navigator.userAgent.match(/ Phone/);
                  },
                  MSIE: function (e) {
                    if (
                      ((e.isMobile = !!navigator.userAgent.match(/ Phone/)),
                      ...
                      (n.HTML.setScriptBug =
                        !e.isIE9 || document.documentMode < 9),
                      (n.Hub.msieHTMLCollectionBug = document.documentMode < 9),
                      document.documentMode < 10 && !o.params.NoMathPlayer)
                    ) {
                      try {
              ...
              i.Browser.Select(n.Message.browsers),
                t.AuthorConfig &&
                  "function" === typeof t.AuthorConfig.AuthorInit &&
                ...
                i.queue.Push(
                  ...
                  ["Message", o],
                  function () {
                    return t.Callback.Queue(o.Jax(), o.Extensions()).Push({});
                  },
                  ["Menu", o],
                  o.onLoad(),
                  function () {
              ...
              for (e = e.replace(/^ +$/gm, ""); e; )
                if (
                  ((r = this.rules.newline.exec(e)) &&
                    ...
                    1 < r[0].length && this.tokens.push({ type: "space" })),
                  ...
                  (e = e.substring(r[0].length)),
                    ...
                    this.tokens.push({
                      type: "code",
                      text: this.options.pedantic ? r : b(r, "\n"),
                    });
                  ...
                  for (
                    e = e.substring(r[0].length),
                      u = {
                        type: "list_start",
                        ordered: (g = 1 < (s = r[2]).length),
                        start: g ? +s : "",
                        loose: !1,
                      },
                      this.tokens.push(u),
                      i = !(c = []),
                      m = (r = r[0].match(this.rules.item)).length,
                      p = 0;
                    p < m;
                    p++
                  )
                  ...
                  if (u.loose)
                    for (m = c.length, p = 0; p < m; p++) c[p].loose = !0;
                  ...
                  (e = e.substring(r[0].length)),
                    ...
                    (f = r[1].toLowerCase().replace(/\s+/g, " ")),
                    this.tokens.links[f] ||
                      (this.tokens.links[f] = { href: r[2], title: r[3] });
                else if (
            ...
            (r.prototype.output = function (e) {
              for (var t, n, i, o, s, a, l = ""; e; )
                if ((s = this.rules.escape.exec(e)))
                  (e = e.substring(s[0].length)), (l += c(s[1]));
                  ...
                  if (-1 < u) {
                    var h =
                      s[0].length - (s[2].length - u) - (s[3] || "").length;
                    (s[2] = s[2].substring(0, u)),
                      (s[0] = s[0].substring(0, h).trim()),
                      (s[3] = "");
                  }
                  (e = e.substring(s[0].length)),
                    (this.inLink = !0),
                  ...
                  (e = e.substring(s[0].length)), (l += this.renderer.br());
                  ...
                  if ((s = this.rules.text.exec(e)))
                    (e = e.substring(s[0].length)),
                      this.inRawBlock
                        ...
                        : (l += this.renderer.text(c(this.smartypants(s[0]))));
                  else if (e)
                    throw new Error(
                  ...
                  "code" !== e.type
                    ...
                    : s(e.text, e.lang, function (t, n) {
                        return t
                          ...
                          : null == n || n === e.text
                          ? --r || u()
                          : ((e.text = n), (e.escaped = !0), void (--r || u()));
                      });
                })(o[a]);
            } else
              try {
                return t && (t = x({}, M.defaults, t)), l.parse(i.lex(e, t), t);
              } catch (e) {
                if (
                  ((e.message +=
    ...
    function (e, t, n) {
      ...
      !(function (e, t, n, i, o) {
        ...
        var l,
          ...
          h = function (e) {
            return r.a.Localization._.apply(
              r.a.Localization,
              [["MathMenu", e]].concat([].slice.call(arguments, 1))
            );
          },
          ...
          x = e.CombineConfig("MathMenu", {
            ...
            styles: {
              ...
              ".MathJax_MenuLabel": {
                padding: p ? "2px 2em 4px 1.33em" : "1px 2em 3px 1.33em",
                "font-style": "italic",
              },
              ".MathJax_MenuRule": {
                "border-top": p ? "1px solid #CCCCCC" : "1px solid #DDDDDD",
          ...
          b = (r.a.Menu = v.Subclass(
            {
              ...
              Post: function (e, n, i) {
                e || (e = window.event || {});
                var o = document.getElementById("MathJax_MenuFrame");
                o ||
                  ((o = b.Background(this)),
                  delete y.lastItem,
                  delete y.lastMenu,
                  delete b.skipUp,
                  a.Post(["post", b.jax]),
                  (b.isRTL = "rtl" === r.a.Localization.fontDirection()));
                var s = t.Element("div", {
                  onmouseup: b.Mouseup,
                  ondblclick: l,
                  ondragstart: l,
                ...
                ("contextmenu" !== e.type && "mouseover" !== e.type) ||
                  (s.className += " MathJax_ContextMenu"),
                  i || r.a.Localization.setCSS(s);
                for (var u = 0, c = this.items.length; u < c; u++)
                ...
                b.isMobile &&
                  ...
                  o.appendChild(s),
                  (this.posted = !0),
                  s.offsetWidth && (s.style.width = s.offsetWidth + 2 + "px");
                var h = e.pageX,
                  d = e.pageY,
                  ...
                  m = window.getComputedStyle
                    ...
                    : { marginLeft: "0px" },
                  g = f.right - Math.min(0, f.left) + parseFloat(m.marginLeft);
                if (
                  (!h &&
                    !d &&
                    "clientX" in e &&
                  ...
                  var v = "left",
                    M = n.offsetWidth;
                  for (h = b.isMobile ? 30 : M - 2, d = 0; n && n !== o; )
                    (h += n.offsetLeft), (d += n.offsetTop), (n = n.parentNode);
                  b.isMobile ||
                    (((b.isRTL && h - M - s.offsetWidth > this.margin) ||
                      (!b.isRTL && h + s.offsetWidth > g - this.margin)) &&
                      ((v = "right"),
                      (h = Math.max(this.margin, h - M - s.offsetWidth + 6)))),
                    p ||
                  ...
                  h + s.offsetWidth > g - this.margin &&
                    ...
                    b.isMobile &&
                      ((h = Math.max(5, h - Math.floor(s.offsetWidth / 2))),
                      (d -= 20)),
              ...
              Remove: function (e, t) {
                ...
                return (
                  ...
                  b.jax.hover && (delete b.jax.hover.nofade, u.UnHover(b.jax)),
                  b.Unfocus(t),
                  "mousedown" === e.type && b.CurrentNode().blur(),
                  l(e)
                );
              },
              Find: function (e) {
                return this.FindN(1, e, [].slice.call(arguments, 1));
              },
              FindId: function (e) {
                return this.FindN(0, e, [].slice.call(arguments, 1));
              },
              FindN: function (e, t, n) {
                for (var i = 0, o = this.items.length; i < o; i++)
                  if (this.items[i].name[e] === t)
                    return n.length
                      ? this.items[i].submenu
                        ? this.items[i].submenu.FindN(e, n[0], n.slice(1))
                        : null
                      : this.items[i];
                return null;
              },
            ...
            },
            {
              ...
              Event: function (e, t, n, i) {
                if (b.skipMouseover && "Mouseover" === n && !i) return l(e);
                if (b.skipMouseoverFromKey && "Mouseover" === n)
                  return delete b.skipMouseoverFromKey, l(e);
                if (b.skipUp) {
                  if (n.match(/Mouseup|Touchend/)) return delete b.skipUp, l(e);
                  ("Touchstart" === n ||
                    ("Mousedown" === n && !b.skipMousedown)) &&
                    delete b.skipUp;
                }
                e || (e = window.event);
                var o = t.menuItem;
              ...
              SetWH: function () {
                ...
                e &&
                  (((e = e.firstChild).style.width = e.style.height = "1px"),
              ...
              AllNodes: function () {
                for (
                  var e, t = r.a.Hub.getAllJax(), n = [], i = 0;
                  (e = t[i]);
                  i++
                )
                  n.push(b.GetNode(e));
              ...
              Focus: function (e) {
                b.posted ? (b.ActiveNode().tabIndex = -1) : b.Activate(e),
                  (e.tabIndex = 0),
                  b.FocusNode(e);
              },
              ...
              MoveHorizontal: function (e, t, n) {
                if (e.shiftKey) {
                  var i = b.AllNodes(),
                    o = i.length;
                  if (0 !== o) {
                    var s = i[b.Mod(n(b.IndexOf(i, b.CurrentNode())), o)];
                    s !== b.CurrentNode() &&
                      (b.menu.Remove(e, t),
              ...
              UnsetTabIndex: function () {
                for (var e, t = b.AllNodes(), n = 0; (e = t[n]); n++)
                  e.tabIndex > 0 && (e.oldTabIndex = e.tabIndex),
                    (e.tabIndex = -1);
              },
              SetTabIndex: function () {
                for (var t, n = b.AllNodes(), i = 0; (t = n[i]); i++)
                  void 0 !== t.oldTabIndex
                    ? ((t.tabIndex = t.oldTabIndex), delete t.oldTabIndex)
        ...
        var y = (b.ITEM = v.Subclass(
          {
              ...
              for (
                var n =
                  (t =
                    ...
                    .length - 1;
                n >= 0 && y.GetMenuNode(e).menuItem !== t[n].menuItem;
            ...
            TouchEvent: function (e, t, n) {
              return (
                this !== y.lastItem &&
                  (y.lastMenu && b.Event(e, y.lastMenu, "Mouseout"),
        ...
        (b.ENTRY = b.ITEM.Subclass({
          ...
          Attributes: function (t) {
            return (
              ...
              this.disabled && (t.className += " MathJax_MenuDisabled"),
              t
            );
          },
          MoveVertical: function (e, t, n) {
            for (
              var i, o = y.GetMenuNode(t), r = [], s = 0, a = o.menuItem.items;
              (i = a[s]);
              s++
            )
              i.hidden || r.push(i);
            ...
            if (-1 !== l) {
              ...
              do {
                l = b.Mod(n(l), u);
              } while (r[l].hidden || !c[l].role || "separator" === c[l].role);
          ...
          MoveHorizontal: function (e, t, n, i) {
            ...
            if ((o.menuItem === b.menu && e.shiftKey && n(e, t), !i)) {
              o.menuItem !== b.menu && this.Deactivate(t);
              for (var r = o.previousSibling.childNodes, s = r.length; s--; ) {
                var a = r[s];
                if (a.menuItem.submenu && a.menuItem.submenu === o.menuItem) {
                  b.Focus(a);
                  break;
                }
              }
          ...
          Activate: function (e, t) {
            this.Deactivate(t),
              this.disabled || (t.className += " MathJax_MenuActive"),
          ...
          (b.ITEM.SUBMENU = b.ENTRY.Subclass({
            ...
            Init: function (e, t) {
              ...
              t instanceof b.ITEM || (this.With(t), n++),
                (this.submenu = b.apply(b, [].slice.call(arguments, n)));
            },
            Label: function (e, t) {
              return (
            ...
            Timer: function (e, t) {
              this.ClearTimer(),
                (e = { type: e.type, clientX: e.clientX, clientY: e.clientY }),
                (this.timer = setTimeout(i(["Mouseup", this, e, t]), x.delay));
            },
            ClearTimer: function () {
            ...
            Touchend: function (e, t) {
              var n = this.submenu.posted,
                i = this.SUPER(arguments).Touchend.apply(this, arguments);
              return (
                n && (this.Deactivate(t), delete y.lastItem, delete y.lastMenu),
                i
              );
            },
            Mouseout: function (e, t) {
              this.submenu.posted || this.Deactivate(t), this.ClearTimer();
            },
            Mouseover: function (e, t) {
              this.Activate(e, t);
            },
            ...
            Activate: function (e, t) {
              this.disabled ||
                (this.Deactivate(t), (t.className += " MathJax_MenuActive")),
                this.submenu.posted ||
                  (this.DeactivateSubmenus(t), b.isMobile || this.Timer(e, t)),
                b.Focus(t);
            },
            MoveVertical: function (e, t, n) {
              this.ClearTimer(),
              ...
              if (i) {
                if (!this.disabled)
                  if (this.submenu.posted) {
                    var o = y.GetMenuNode(t).nextSibling.childNodes;
                    o.length > 0 && this.submenu.items[0].Activate(e, o[0]);
          ...
          (b.ITEM.RADIO = b.ENTRY.Subclass({
            ...
            Attributes: function (t) {
              var n =
                x.settings[this.variable] === this.value ? "true" : "false";
              return (
            ...
            Label: function (e, t) {
              var n = { className: "MathJax_MenuRadioCheck" + this.rtlClass() };
              return (
            ...
            Mouseup: function (e, t) {
              if (!this.disabled) {
                for (
                  var n = t.parentNode.childNodes, i = 0, o = n.length;
                  i < o;
                  i++
                ) {
                  var r = n[i].menuItem;
                  r &&
                    ...
                    (n[i].firstChild.style.display = "none");
                }
                (t.firstChild.display = ""),
                  (x.settings[this.variable] = this.value),
                  (b.cookie[this.variable] = x.settings[this.variable]),
                  b.saveCookie(),
                  a.Post(["radio button", this]);
              }
              return (
                this.Remove(e, t),
                this.action && !this.disabled && this.action.call(b, this),
                l(e)
              );
            },
          })),
          (b.ITEM.CHECKBOX = b.ENTRY.Subclass({
            ...
            Attributes: function (t) {
              var n = x.settings[this.variable] ? "true" : "false";
              return (
                (t = e.Insert({ "aria-checked": n }, t)),
                (t = this.SUPER(arguments).Attributes.call(this, t))
              );
            ...
            Label: function (e, t) {
              var n = { className: "MathJax_MenuCheck" + this.rtlClass() };
              return (
            ...
            Mouseup: function (e, t) {
              return (
                this.disabled ||
                  ((t.firstChild.display = x.settings[this.variable]
                    ? "none"
                    : ""),
                  (x.settings[this.variable] = !x.settings[this.variable]),
                  (b.cookie[this.variable] = x.settings[this.variable]),
                  b.saveCookie(),
          ...
          (b.ITEM.LABEL = b.ENTRY.Subclass({
            ...
            Label: function (e, t) {
              return (e.className += " MathJax_MenuLabel"), [this.Name()];
            },
            Activate: function (e, t) {
          ...
          (b.ITEM.RULE = b.ITEM.Subclass({
            ...
            Attributes: function (t) {
              return (
                (t = e.Insert({ "aria-orientation": "vertical" }, t)),
                (t = this.SUPER(arguments).Attributes.call(this, t))
              );
            },
            Label: function (e, t) {
          ...
          (b.About = function (n) {
            ...
            s.push([
              ...
              b.About.GetJax(s, r.a.InputJax, ["InputJax", "%1 Input Jax v%2"]),
            ...
            var a = t.addElement(
              b.About.div,
              "div",
              { id: "MathJax_About", tabIndex: 0, onkeydown: b.About.Keydown },
              [
            ...
            "mouseup" === n.type && (a.className += " MathJax_MousePost"),
              a.focus(),
              r.a.Localization.setCSS(a);
            var l = document.documentElement || {},
              u = window.innerHeight || l.clientHeight || l.scrollHeight || 0;
            b.prototype.msieAboutBug
              ? ((a.style.width = "20em"),
                (a.style.position = "absolute"),
                (a.style.left =
                  Math.floor(
                    (document.documentElement.scrollWidth - a.offsetWidth) / 2
                  ) + "px"),
                (a.style.top =
                  Math.floor((u - a.offsetHeight) / 3) +
                  document.body.scrollTop +
                  "px"))
              : ((a.style.marginLeft = Math.floor(-a.offsetWidth / 2) + "px"),
                (a.style.top = Math.floor((u - a.offsetHeight) / 3) + "px"));
          }),
          (b.About.Remove = function (e) {
            b.About.div &&
              (document.body.removeChild(b.About.div), delete b.About.div);
          }),
          (b.About.Keydown = function (e) {
            (e.keyCode !== c.ESCAPE &&
              ("MathJax_AboutClose" !== this.id ||
                (e.keyCode !== c.SPACE && e.keyCode !== c.RETURN))) ||
          ...
          (b.About.GetJax = function (e, t, n, i) {
            ...
            for (var r in t)
              t.hasOwnProperty(r) &&
                t[r] &&
                ((i && t[r].version) || (t[r].isa && t[r].isa(t))) &&
                o.push(h(n[0], n[1], t[r].id || r, t[r].version));
            o.sort();
            for (var s = 0, a = o.length; s < a; s++) e.push(o[s], ["br"]);
            return e;
          }),
          (b.About.GetFont = function () {
            ...
            return (
              ({
                ...
                "HTML-CSS": e.imgFonts
                  ? "image"
                  : (e.webFonts ? "web" : "local") + " " + e.fontInUse,
              }[e.id] || "generic") + " fonts"
            );
          }),
          (b.About.GetFormat = function () {
            ...
            if ("HTML-CSS" === e.id && e.webFonts && !e.imgFonts)
              return e.allowWebFonts.replace(/otf/, "woff or otf") + " fonts";
          }),
          (b.Help = function (e) {
            n.Require("[MathJax]/extensions/HelpDialog.js", function () {
          ...
          (b.ShowSource = function (e) {
            ...
            if (b.jax)
              if ("MathML" === this.format) {
                ...
                if (o && "undefined" !== typeof o.mbase.prototype.toMathML)
                  try {
                    b.ShowSource.Text(b.jax.root.toMathML("", b.jax), e);
                  } catch (a) {
                    if (!a.restart) throw a;
                    i.After([this, b.ShowSource, t], a.restart);
                  }
                  ...
                  return (
                    ...
                    void i.Queue(
                      n.Require("[MathJax]/extensions/toMathML.js"),
                      function () {
                        delete n.loadingToMathML,
                          o.mbase.prototype.toMathML ||
                            (o.mbase.prototype.toMathML = function () {});
                      },
                      [this, b.ShowSource, t]
                    )
                  );
                ...
                s.data[0] && b.ShowSource.Text(s.data[0].toString());
              } else {
                if (null == b.jax.originalText)
                  return void alert(
                    h("NoOriginalForm", "No original form available")
                  );
          ...
          (b.ShowSource.Window = function (e) {
            if (!b.ShowSource.w) {
              ...
              b.ShowSource.w = window.open("", "_blank", t.join(","));
            }
          ...
          (b.ShowSource.Text = function (e, t) {
            ...
            if (b.isMobile)
              ...
              n.document.open(),
                ...
                n.document.write(
                  "<table><tr><td><pre>" + e + "</pre></td></tr></table>"
                ),
                n.document.write("</body></html>"),
                n.document.close();
          ...
          (b.Scale = function () {
            var t,
              n,
              i = ["CommonHTML", "HTML-CSS", "SVG", "NativeMML", "PreviewHTML"],
              r = i.length,
              s = 100;
            for (t = 0; t < r; t++)
              if ((n = o[i[t]])) {
            ...
            if (a)
              if (a.match(/^\s*\d+(\.\d*)?\s*%?\s*$/))
                if ((a = parseFloat(a))) {
                  if (a !== s) {
                    for (t = 0; t < r; t++)
                      (n = o[i[t]]) && (n.config.scale = a);
                    (b.cookie.scale = e.config.scale = a),
                      b.saveCookie(),
                      e.Queue(["Rerender", e]);
                  }
                } else alert(h("NonZeroScale", "The scale should not be zero"));
              else
                alert(
                  h(
                    "PercentScale",
          ...
          (b.Renderer = function () {
            ...
            if (n[0] !== x.settings.renderer) {
              ...
              switch (x.settings.renderer) {
                case "NativeMML":
                  x.settings.warnedMML ||
                    (r.isChrome && "24." !== r.version.substr(0, 3)
                      ? (i = s.MML.WebKit)
                      : r.isSafari && !r.versionAtLeast("5.0")
                      ? (i = s.MML.WebKit)
                      : r.isMSIE
                      ? r.hasMathPlayer || (i = s.MML.MSIE)
                      : (i = r.isEdge ? s.MML.WebKit : s.MML[r]),
                    (o = "warnedMML"));
                  break;
                case "SVG":
                  x.settings.warnedSVG || (r.isMSIE && !m && (i = s.SVG.MSIE));
              }
              if (i) {
                if (
                  ((i = h(i[0], i[1])),
              ...
              e.Queue(
                ["setRenderer", e, x.settings.renderer, "jax/mml"],
                ["Rerender", e]
              );
            }
          }),
          ...
          (b.AssistiveMML = function (e, t) {
            ...
            i
              ...
              : t ||
                n.Require("[MathJax]/extensions/AssistiveMML.js", [
                  "AssistiveMML",
                  b,
                  e,
                  !0,
          ...
          (b.LoadLocale = function () {
            ...
            e &&
              ...
              n.Require(e, function (t) {
                t != n.STATUS.OK &&
                  alert(
                    h("BadData", "Failed to load translation data from %1", e)
                  );
              }));
          }),
          (b.MPEvents = function (e) {
            ...
            if (m)
              ...
              if (x.settings.mpMouse && !confirm(h.apply(h, n.IE8warning)))
                return (
              ...
              (x.settings.mpContext = x.settings.mpMouse),
                (b.cookie.mpContext = b.cookie.mpMouse = x.settings.mpMouse),
                b.saveCookie(),
          ...
          e.Browser.Select({
            MSIE: function (e) {
              var t = "BackCompat" === document.compatMode,
                n = e.versionAtLeast("8.0") && document.documentMode > 7;
              b.Augment({
                margin: 20,
            ...
            Firefox: function (e) {
              (b.skipMouseover = e.isMobile && e.versionAtLeast("6.0")),
          ...
          (b.CreateLocaleMenu = function () {
            if (b.menu) {
              ...
              for (var s = 0, a = n.length; s < a; s++) {
                ...
                l ? (l += " (" + n[s] + ")") : (l = n[s]),
                  e.items.push(
                    y.RADIO([n[s], l], "locale", { action: b.Locale })
                  );
              }
          ...
          (b.CreateAnnotationMenu = function () {
            if (b.menu) {
              var e = b.menu.Find("Show Math As", "Annotation").submenu,
          ...
          e.Register.StartupHook("End Config", function () {
            (x.settings = e.config.menuSettings),
              ...
              (b.menu = b(
                y.SUBMENU(
                  ["Show", "Show Math As"],
                  y.COMMAND(["MathMLcode", "MathML Code"], b.ShowSource, {
                    nativeTouch: !0,
                    format: "MathML",
                  }),
                  y.COMMAND(["Original", "Original Form"], b.ShowSource, {
                    nativeTouch: !0,
                  }),
                  y.SUBMENU(["Annotation", "Annotation"], { disabled: !0 }),
                  y.RULE(),
                  y.CHECKBOX(
                ...
                y.SUBMENU(
                  ...
                  y.SUBMENU(
                    ...
                    y.RADIO(["Hover", "Hover"], "zoom", { action: b.Zoom }),
                    y.RADIO(["Click", "Click"], "zoom", { action: b.Zoom }),
                    y.RADIO(["DoubleClick", "Double-Click"], "zoom", {
                      action: b.Zoom,
                    }),
                    y.RADIO(["NoZoom", "No Zoom"], "zoom", { value: "None" }),
                    y.RULE(),
                    y.LABEL(["TriggerRequires", "Trigger Requires:"]),
                    y.CHECKBOX(
                      e.Browser.isMac ? ["Option", "Option"] : ["Alt", "Alt"],
                      "ALT"
                    ),
                    y.CHECKBOX(["Command", "Command"], "CMD", {
                      hidden: !e.Browser.isMac,
                    }),
                    y.CHECKBOX(["Control", "Control"], "CTRL", {
                      hidden: e.Browser.isMac,
                    }),
                  ...
                  y.SUBMENU(
                    ...
                    y.RADIO(["HTML-CSS", "HTML-CSS"], "renderer", {
                      action: b.Renderer,
                    }),
                    y.RADIO(["CommonHTML", "Common HTML"], "renderer", {
                      action: b.Renderer,
                      value: "CommonHTML",
                    }),
                    y.RADIO(["PreviewHTML", "Preview HTML"], "renderer", {
                      action: b.Renderer,
                      value: "PreviewHTML",
                    }),
                    y.RADIO(["MathML", "MathML"], "renderer", {
                      action: b.Renderer,
                      value: "NativeMML",
                    }),
                    y.RADIO(["SVG", "SVG"], "renderer", { action: b.Renderer }),
                    y.RADIO(["PlainSource", "Plain Source"], "renderer", {
                      action: b.Renderer,
                      value: "PlainSource",
                    }),
                    y.RULE(),
                    y.CHECKBOX(["FastPreview", "Fast Preview"], "FastPreview")
                  ),
                  y.SUBMENU(
                    "MathPlayer",
                    {
                      hidden: !e.Browser.isMSIE || !x.showMathPlayer,
                      disabled: !e.Browser.hasMathPlayer,
                    },
                    y.LABEL(["MPHandles", "Let MathPlayer Handle:"]),
                    y.CHECKBOX(["MenuEvents", "Menu Events"], "mpContext", {
                      action: b.MPEvents,
                      hidden: !m,
                    }),
                    y.CHECKBOX(["MouseEvents", "Mouse Events"], "mpMouse", {
                      action: b.MPEvents,
                      hidden: !m,
                    }),
                    y.CHECKBOX(
                  ...
                  y.SUBMENU(
                    ...
                    y.LABEL(["ForHTMLCSS", "For HTML-CSS:"]),
                    y.RADIO(["Auto", "Auto"], "font", { action: b.Font }),
                    y.RULE(),
                    y.RADIO(["TeXLocal", "TeX (local)"], "font", {
                      action: b.Font,
                    }),
                    y.RADIO(["TeXWeb", "TeX (web)"], "font", {
                      action: b.Font,
                    }),
                    y.RADIO(["TeXImage", "TeX (image)"], "font", {
                      action: b.Font,
                    }),
                    y.RULE(),
                    y.RADIO(["STIXLocal", "STIX (local)"], "font", {
                      action: b.Font,
                    }),
                    y.RADIO(["STIXWeb", "STIX (web)"], "font", {
                      action: b.Font,
                    }),
                    y.RULE(),
                    y.RADIO(["AsanaMathWeb", "Asana Math (web)"], "font", {
                      action: b.Font,
                    }),
                    y.RADIO(["GyrePagellaWeb", "Gyre Pagella (web)"], "font", {
                      action: b.Font,
                    }),
                    y.RADIO(["GyreTermesWeb", "Gyre Termes (web)"], "font", {
                      action: b.Font,
                    }),
                    y.RADIO(["LatinModernWeb", "Latin Modern (web)"], "font", {
                      action: b.Font,
                    }),
                    y.RADIO(["NeoEulerWeb", "Neo Euler (web)"], "font", {
                      action: b.Font,
                    })
                  ),
                  y.SUBMENU(
                    ...
                    y.RADIO(["MathJax", "MathJax"], "context"),
              ...
              b.isMobile &&
                (function () {
                  var e = x.settings,
                    t = b.menu.Find("Math Settings", "Zoom Trigger").submenu;
                  (t.items[0].disabled = t.items[1].disabled = !0),
                    ("Hover" !== e.zoom && "Click" != e.zoom) ||
                      (e.zoom = "None"),
                    (t.items = t.items.slice(0, 4)),
                    navigator.appVersion.match(/[ (]Android[) ]/) &&
                      b.ITEM.SUBMENU.Augment({ marker: "\xbb" });
                })(),
              b.CreateLocaleMenu(),
          ...
          (b.showRenderer = function (e) {
            (b.cookie.showRenderer = x.showRenderer = e),
              b.saveCookie(),
              (b.menu.Find("Math Settings", "Math Renderer").hidden = !e);
          }),
          (b.showMathPlayer = function (e) {
            (b.cookie.showMathPlayer = x.showMathPlayer = e),
              b.saveCookie(),
              (b.menu.Find("Math Settings", "MathPlayer").hidden = !e);
          }),
          (b.showFontMenu = function (e) {
            (b.cookie.showFontMenu = x.showFontMenu = e),
              b.saveCookie(),
              (b.menu.Find("Math Settings", "Font Preference").hidden = !e);
          }),
          (b.showContext = function (e) {
            (b.cookie.showContext = x.showContext = e),
              b.saveCookie(),
              (b.menu.Find("Math Settings", "Contextual Menu").hidden = !e);
          }),
          (b.showDiscoverable = function (e) {
            (b.cookie.showDiscoverable = x.showDiscoverable = e),
              b.saveCookie(),
              (b.menu.Find("Math Settings", "Highlight on Hover").hidden = !e),
              (b.menu.Find("Math Settings", "discover_rule").hidden = !e);
          }),
          ...
          r.a.Hub.Register.StartupHook("HTML-CSS Jax Ready", function () {
        ...
        (function (e, t, n, i, o) {
          ...
          r.a.Hub.Register.StartupHook("MathEvents Ready", function () {
          ...
          var c = (r.a.Extension.MathZoom = {
            ...
            Click: function (e, t) {
              if ("Click" === this.settings.zoom) return this.Zoom(e, t);
            },
            ...
            Hover: function (e, t) {
              return "Hover" === this.settings.zoom && (this.Zoom(e, t), !0);
            },
            Zoom: function (n, i) {
              this.Remove(), a.ClearHoverTimer(), l.ClearSelection();
              ...
              "visible" !== this.getOverflow(h) &&
                ...
                (p = Math.floor(0.85 * p));
              var f = t.Element("span", { id: "MathJax_ZoomFrame" }, [
                  [
                    "span",
              ...
              i.parentNode.insertBefore(f, i),
                ...
                g.addEventListener &&
                  g.addEventListener("mousedown", this.Remove, !0);
              ...
              if (this.msieZIndexBug) {
                ...
                (f.style.position = "relative"),
                  (f.style.zIndex =
                    u.styles["#MathJax_ZoomOverlay"]["z-index"]),
                  (f = y);
              }
              ...
              return (
                this.msiePositionBug &&
                  ...
                  m.offsetHeight > p &&
                    ((m.style.height = p + "px"),
                    (m.style.width = M.zW + this.scrollSize + "px")),
                  m.offsetWidth > d &&
                    ((m.style.width = d + "px"),
                    (m.style.height = M.zH + this.scrollSize + "px"))),
                ...
                this.msieTrapEventBug &&
                  ...
                  (b.style.left =
                    parseFloat(m.style.left) + m.clientLeft + "px"),
                  (b.style.top = parseFloat(m.style.top) + m.clientTop + "px")),
                (m.style.visibility = ""),
                "Hover" === this.settings.zoom && (x.onmouseover = this.Remove),
                window.addEventListener
            ...
            Resize: function (e) {
              ...
              var t = document.getElementById("MathJax_ZoomFrame"),
                n = document.getElementById("MathJax_ZoomOverlay"),
                i = c.getXY(t),
                o = c.findContainer(t);
              ...
              return (
                (n.style.left = -i.x + "px"),
                (n.style.top = -i.y + "px"),
                c.msiePositionBug ? setTimeout(c.SetWH, 0) : c.SetWH(),
                i
              );
            },
            SetWH: function () {
              ...
              if (e) {
                e.style.display = "none";
                var t =
                  e.scroll_parent || document.documentElement || document.body;
                (e.style.width = t.scrollWidth + "px"),
                  (e.style.height =
                    Math.max(t.clientHeight, t.scrollHeight) + "px"),
                  (e.style.display = "");
              }
            },
            ...
            getOverflow: window.getComputedStyle
              ...
              : function (e) {
                  return (e.currentStyle || { overflow: "visible" }).overflow;
                },
            getBorder: function (e) {
              var t = { thin: 1, medium: 2, thick: 3 },
                n = window.getComputedStyle
                  ? getComputedStyle(e)
                  : e.currentStyle || { borderLeftWidth: 0, borderTopWidth: 0 },
                i = n.borderLeftWidth,
                o = n.borderTopWidth;
              return {
            ...
            getXY: function (e) {
              ...
              for (
                c.operaPositionBug && (e.style.border = "1px solid"), t = e;
                t.offsetParent;

              )
                (i += t.offsetTop), (t = t.offsetParent);
              return (
                c.operaPositionBug && (e.style.border = ""), { x: n, y: i }
              );
            },
            Remove: function (n) {
              var i = document.getElementById("MathJax_ZoomFrame");
              if (i) {
                var o = r.a.OutputJax[i.previousSibling.jaxID].getJaxFromMath(
                  i.previousSibling
                );
                if (
                  (e.signal.Post(["math unzoomed", o]),
                  i.parentNode.removeChild(i),
                  (i = document.getElementById("MathJax_ZoomTracker")) &&
                    i.parentNode.removeChild(i),
                  c.operaRefreshBug)
                ) {
                ...
                window.removeEventListener
                  ? removeEventListener("resize", c.Resize, !1)
                  : window.detachEvent
                  ? detachEvent("onresize", c.Resize)
                  : ((window.onresize = c.onresize), delete c.onresize);
              }
              return s(n);
            },
          });
          e.Browser.Select({
            MSIE: function (e) {
              ...
              (c.msiePositionBug = !n),
                (c.msieSizeBug =
                  ...
                  (!document.documentMode || 7 === t || 8 === t)),
                (c.msieZIndexBug = t <= 7),
                (c.msieInlineBlockAlignBug = t <= 7),
                (c.msieTrapEventBug = !window.addEventListener),
                "BackCompat" === document.compatMode && (c.scrollSize = 52),
            ...
            r.a.Callback.Queue(
              ["StartupHook", r.a.Hub.Register, "Begin Styles", {}],
              ["Styles", n, u.styles],
              ["Post", e.Startup.signal, "MathZoom Ready"],
              ["loadComplete", n, "[MathJax]/extensions/MathZoom.js"]
            );
        })(
          r.a.Hub,
          r.a.HTML,
                        ...
                        new Promise(function (t) {
                          requestAnimationFrame(function () {
                            e(N.$refs.我的侧边栏).css(
                              ...
                              e(
                                N.$refs.我的侧边栏.querySelectorAll("ul")
                              ).addClass("navbar-nav"),
                              e(
                                N.$refs.我的侧边栏.querySelectorAll("a")
                              ).addClass(
            ...
            if (
              ...
              a
                ...
                : f(r)
                    .then(function (i) {
                      return (
                        e("#collapsibleNavbar").removeClass("show"),
                        e("#my\u4e3b\u4f53").css(
                          "padding-top",
                          e("#my\u5bfc\u822a\u680f").height()
                        ),
                        (function (i) {
                          return new Promise(function (o) {
                            t.error_id.hide(),
                              ...
                              requestAnimationFrame(function () {
                                n(),
                                  t.highlight_code &&
                                    Array.from(e("pre code")).forEach(function (
                                      e
                                    ) {
                                      C.highlightBlock(e);
                                    }),
                          ...
                          .then(function () {
                            return new Promise(function (e) {
                              requestAnimationFrame(function () {
                                if (s && s.Extension["Tex/AMSmath"]) {
                                  (s.Extension["TeX/AMSmath"].startNumber = 0),
                                    (s.Extension["TeX/AMSmath"].labels = {});
                                  var t = N.$refs.markdown内容;
                                  s.Hub.Queue(["Typeset", s.Hub, t]);
                                }
                                e();
                              });
                            });
                          ...
                          .then(function () {
                            return new Promise(function (e) {
                              requestAnimationFrame(function () {
                                Array.from(c()("code.hljs")).forEach(function (
                                  e
                                ) {
                                  var t =
                                    "clip" +
                                ...
                                var t = N.$refs.markdown内容.innerHTML;
                                P.set(r, t), e();
                              });
                            });
                          })
        ...
        return new Promise(function (e) {
          requestAnimationFrame(function () {
            if (window.innerWidth > 550) {
              ...
              (t = Math.max(t, 20)),
                c()("#contentcontainer").css({ "padding-left": t + 20 });
        ...
        j = {
            ...
            c()("#my\u4e3b\u4f53").css(
              ...
              c()(function () {
                var e = Object(i.a)(
                  ...
                  n = e.subtitle || "Lightweight Markdown Documentation System",
                  o = e.github_username,
                  r = e.github_repo;
                (H.index = e.index),
                  (document.title = t + " " + n),
                  ...
                  window.addEventListener("hashchange", function () {
                    scrollTo(0, 0),
                      ...
                      window.innerWidth < 550 && (N.xianshicebianlan = !1);
                  });
              });
          },
          data: function () {
          ...
          methods: {
            togglecebian: function () {
              (this.xianshicebianlan = !this.xianshicebianlan), D();
            },
          },
        },
        F = n(15),
        z = Object(F.a)(
          ...
          function () {
            ...
            return n("div", { attrs: { id: "root" } }, [
                      ...
                      n("div", [
                        n(
                          "a",
                          {
                            ...
                            staticStyle: { top: "0" },
                            attrs: { href: "#README", id: "title" },
                            domProps: { textContent: e._s(e.mytitle) },
                          },
                          [e._v("Markdon Reader")]
                        ),
                        e._v(" "),
                        n(
                          "button",
                          {
                            staticClass:
                              "mui-btn mui-btn-primary mui-btn-outlined",
                            attrs: { type: "button", id: "cebianlantoggle" },
                            on: { click: e.togglecebian },
                          },
                ...
                n(
                  ...
                  [
                    n("aside", {
                      ...
                      domProps: { innerHTML: e._s(e.mulu) },
                    }),
                  ]
                ),
              ]),
              ...
              n(
                "div",
                { staticClass: "container", attrs: { id: "my\u4e3b\u4f53" } },
                [
                  e._m(0),
                  e._v(" "),
                  n("div", [
                    n("div", { attrs: { id: "contentcontainer" } }, [
                      n("h5", {
                        attrs: { id: "markdownurlsrc" },
                        domProps: { textContent: e._s(e.urltext) },
                      }),
                      e._v(" "),
                      e.showerror
                        ? n("h5", {
                            attrs: { id: "markdownerror" },
                            domProps: { textContent: e._s(e.errorcontent) },
                          })
                        : e._e(),
                      e._v(" "),
                      n("div", {
          ...
          [
            function () {
              var e = this.$createElement,
                t = this._self._c || e;
              return t("div", { attrs: { id: "loadingparent" } }, [
            ...
            function () {
              ...
              return t("div", { staticStyle: { display: "none" } }, [
                t("div", { attrs: { id: "back_to_top" } }, [this._v("top")]),
              ]);
            },
            function () {
              var e = this.$createElement,
                t = this._self._c || e;
              return t("div", [t("h1", { attrs: { id: "error" } })]);
            },
          ],
          !1,
          null,
      ...
      (document.getElementById("root").innerHTML =
        ...
        (N = new B.a(Object(i.a)({ el: document.getElementById("root") }, z)));
    },
  ],
  [[16, 1, 2]],
]);
